CLASS zcl_generate_demo_data_mipo DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_GENERATE_DEMO_DATA_MIPO IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    DELETE FROM zrap_abook_mipo.

    INSERT zrap_atrav_mipo FROM (
        SELECT
          FROM /dmo/travel
          FIELDS
            uuid(  )      AS travel_uuid           ,
    ...
    INSERT zrap_abook_mipo FROM (
        SELECT
          FROM   /dmo/booking    AS booking
            JOIN zrap_atrav_mipo AS z
